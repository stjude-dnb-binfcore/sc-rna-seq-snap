...
analysis_dir <- file.path(root_dir, "analyses", "gene-ontology-go-enrichment-analysis") 
...
rmarkdown::render('01-gene-ontology-go-enrichment-analysis.Rmd', clean = TRUE,
                  output_dir = file.path(module_plots_dir),
                  output_file = c(paste('Report-', 'gene-ontology-go-enrichment-analysis', '-', Sys.Date(), sep = '')),
                  output_format = 'all',
