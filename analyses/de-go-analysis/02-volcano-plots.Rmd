...
|-----------|---------------------|---------------------------------------------|
| **Red**   | Up‑regulated        | log2FC > 0 & adjusted p-value ≤ α           |
| **Blue**  | Down‑regulated      | log2FC < 0 & adjusted p-value ≤ α           |
| **Grey**  | Not significant     | adjusted p-value > α or \|log2FC\| below threshold |
...
volcano_plot_results <- crete_volcano_plot(all.markers = all.markers_overall, n_value = n_value, plots_dir = plots_dir_overall)
```
...
volcano_plot_results <- crete_volcano_plot(all.markers = all.markers_condition_value1, n_value = n_value, plots_dir = plots_dir_condition1)
```
