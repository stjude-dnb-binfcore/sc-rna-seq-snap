...
- log2FC > 0 (higher expression in the given cell type or the condition within the given cell type, e.g. Treatment vs Control)
...
- log2FC < 0 (lower expression in the given cell type or the condition within the given cell type, e.g. Treatment vs Control)
- p-value ≤ α
...
|-----------|--------------------------|----------------------------------------------------|-----------------------------------------------------------------|
| **Red**   | Up‑regulated             | log2FC > 0 & p-value ≤ α                  |   Right side (positive log₂FC)                                  |
| **Red**   | Down‑regulated           | log2FC < 0 & p-value ≤ α                  |   Left side (negative log₂FC)                                   |
