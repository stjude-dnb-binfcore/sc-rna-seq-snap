...
################################################################################################################
# Step 1
rmarkdown::render('01-de-volcano-plots.Rmd', clean = TRUE,
                  output_dir = file.path(module_plots_dir),
                  output_file = c(paste('Report-', 'de-volcano-plots', '-', Sys.Date(), sep = '')),
                  output_format = 'all',
...
################################################################################################################
# Step 2
rmarkdown::render('02-go-clusterprofiler.Rmd', clean = TRUE,
                  output_dir = file.path(module_plots_dir),
